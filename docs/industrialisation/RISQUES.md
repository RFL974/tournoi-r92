...
**Dernière mise à jour** : 2026-08-06 (**ÉTAPE 4 ouverte — C-011 validé et en cours, PR #181**) · *2026-08-05 (**session 13 — ÉTAPE 3, volet ①*** : R-028, R-029, R-030 et R-041 ne sont **plus bloqués par une décision en attente** · ⚡ **addendums : R-089, R-090 et R-091 inscrits** — le tournoi suspendu / annulé (**D-030**), un réglage de pause ignoré sans le dire, et deux modes de pause qui coexistent (**D-032**))
