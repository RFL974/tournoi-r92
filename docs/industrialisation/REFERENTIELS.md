...
| **CF-4b** | Neutralisation institutionnelle | ⚠️ **aucun texte extérieur** — fondement **D-038** / `PLAN.md` §14.1 | — | 🔴 **Règle interne du chantier** | 🚧 **EN COURS** — ⭐ **l'état des lots se lit dans [`PLAN.md`](PLAN.md) §CF-4b, qui en est la SOURCE**. ⛔ **Il n'est plus recopié ici** : la recopie de cet état s'était retrouvée **fausse** *(elle annonçait « L2 → L8 à faire » alors que L2, L3, L4 et L6 étaient publiés)* — **§8 quater**, un repère volatil n'a **qu'une seule adresse de référence** |
